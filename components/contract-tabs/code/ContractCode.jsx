...
function replaceVariablesInCodeSnippet(snippet, contractAddress, walletAddress) {
  const envs = Object.keys(snippet);
...
export const ContractCode = ({ contract }) => {
...
function getContractSnippets(snippets, contractName) {
